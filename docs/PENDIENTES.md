...
| 3 | 🟠 **Decidir la histéresis del calentador**: hoy son **5 °C**, mucha oscilación para una pileta. La propuesta es bajarla a **2 °C**. Es una decisión de uso, no técnica | espera decisión |
| 4 | 🟠 **Prueba visual de los cuatro efectos** con música: que la tira siga el ritmo de verdad, no sólo que los números den bien | pendiente |
...
| # | Qué | Detalle |
|---|---|---|
| 6 | 🟠 **Calibrar el piso de ruido en el lugar definitivo** | El taller dio `/piso 12`. El patio de la pileta va a tener otro ruido de fondo: `/espectro` en silencio y ajustar. No requiere recompilar |
